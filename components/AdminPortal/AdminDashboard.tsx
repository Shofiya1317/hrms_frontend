    ...
    try {
      ...
      setStats({
        ...
        deptAttendance: [
          ...
          { dept: 'Operations', rate: 35 },
          { dept: 'Management', rate: 72 },
        ],
        recentActivity: [
          {
            id: '1',
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="flex items-center gap-1.5 text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full">
            <span
              ...
              style={{ boxShadow: '0 0 0 2px #a7f3d0' }}
            />
            Live
          </span>
        </div>
        ...
        {STAT_CARDS.map((card) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              {/* Right side - Icon */}
              <div
                className={`w-8 h-8 rounded-lg ${card.bgCls} flex items-center justify-center flex-shrink-0`}
              >
                  ...
                  return (
                    <div key={d.dept}>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs sm:text-sm font-semibold text-slate-800 truncate mr-2">
                          {d.dept}
                        </span>
                        <span
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-sm">
          ...
          <div className="space-y-2">
            {ALERTS.map((alert) => (
              ...
              >
                <div
                  className={`w-9 h-9 rounded-xl ${alert.bgCls} flex items-center justify-center flex-shrink-0`}
                >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span
                    className={`text-lg sm:text-xl font-black leading-none ${alert.count > 0 ? alert.iconCls : 'text-slate-200'}`}
                  >
                    {alert.count}
                  </span>
                  <ArrowRight
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-sm mt-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {QUICK_ACTIONS.map((action) => (
            ...
            >
              <div
                className={`w-11 h-11 sm:w-12 sm:h-12 rounded-2xl ${action.bgCls} flex items-center justify-center group-hover:scale-110 transition-transform`}
              >
