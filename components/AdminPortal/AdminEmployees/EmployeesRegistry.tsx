...
import { Search, Plus, Download, Eye, Edit, Trash2, CheckCircle, XCircle, Clock, MapPin } from 'lucide-react';
...
const initialEmployees: Employee[] = [
  { id: '1', name: 'Arjun Mehta', avatar: 'AM', role: 'Admin', department: 'Management', email: 'admin@impactree.in', phone: '', location: 'Bengaluru', manager: '', managerId: null, joinDate: 'Jan 2024', status: 'active', employeeId: 'EMP-001' },
  { id: '2', name: 'Rahul Sharma', avatar: 'RS', role: 'Manager', department: 'Operations', email: 'manager@impactree.in', phone: '', location: 'Mumbai', manager: 'Arjun Mehta', managerId: '1', joinDate: 'Mar 2024', status: 'active', employeeId: 'EMP-002' },
  { id: '3', name: 'Ananya Krishnan', avatar: 'AK', role: 'Employee', department: 'Engineering', email: 'employee@impactree.in', phone: '', location: 'Bengaluru', manager: 'Rahul Sharma', managerId: '2', joinDate: 'Jun 2024', status: 'active', employeeId: 'EMP-003' },
];
