...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; border: string }> = {
  ...
  leave: { label: 'Leave', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
              ...
              <div key={stat.label} className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-5 shadow-sm border border-slate-100 hover:shadow-md transition-all duration-200">
                <div className="flex items-center justify-between mb-2 sm:mb-3">
                  ...
                  <div className="text-right">
                    <p className="text-[10px] sm:text-xs text-slate-500">Target: {stat.target}</p>
                  </div>
                </div>
              ...
              <div key={l.type} className="flex items-center gap-3 p-3 rounded-xl border border-slate-100 hover:bg-slate-50 transition-all duration-200 hover:shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-xs sm:text-sm font-bold ml-2 flex-shrink-0" style={{ color: l.color }}>{l.balance}d</span>
                  </div>
                  ...
                  <p className="text-[9px] sm:text-[10px] text-slate-400 mt-1">{l.used} of {l.total} used</p>
                </div>
              </div>
            ))}
          </div>
