...
import { dragOverCursorPlugin } from '@/interfaces/plate/dragOverCursorPlugin';
import { autoformatPlugin } from '@/interfaces/plate/autoformatPlugin';
...
export const plugins = createPlugins(
  [
    ...
    createFontSizePlugin(),
    createFontFamilyPlugin({
      // You can add any custom overrides or options here
    }),
    createHighlightPlugin(),
    createKbdPlugin(),
    createYjsPlugin({
