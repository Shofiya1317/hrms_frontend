import { useEditorRef } from '@udecode/plate-common/dist/react';

import type React from 'react';
import type { BlockquotePlugin } from '@udecode/plate-block-quote/dist/react';
import type {
  CodeBlockPlugin,
  CodeLinePlugin,
} from '@udecode/plate-code-block/dist/react';
import type { TCommentText } from '@udecode/plate-comments';
import type { ElementOf, TElement, TText } from '@udecode/plate-common';
import type { ParagraphPlugin } from '@udecode/plate-common/dist/react';
import type { TExcalidrawElement } from '@udecode/plate-excalidraw';
import type { ExcalidrawPlugin } from '@udecode/plate-excalidraw/dist/react';
import type { HEADING_KEYS } from '@udecode/plate-heading';
import type { HorizontalRulePlugin } from '@udecode/plate-horizontal-rule/dist/react';
import type { TLinkElement } from '@udecode/plate-link';
import type { LinkPlugin } from '@udecode/plate-link/dist/react';
...
import type {
  ...
  NumberedListPlugin,
  TodoListPlugin,
} from '@udecode/plate-list/dist/react';
import type { TImageElement, TMediaEmbedElement } from '@udecode/plate-media';
import type { ImagePlugin, MediaEmbedPlugin } from '@udecode/plate-media/dist/react';
import type {
  TMentionElement,
...
import type {
  MentionInputPlugin,
  MentionPlugin,
} from '@udecode/plate-mention/dist/react';
import type { TTableElement } from '@udecode/plate-table';
import type {
  TableCellPlugin,
  TablePlugin,
  TableRowPlugin,
} from '@udecode/plate-table/dist/react';
import type { TToggleElement } from '@udecode/plate-toggle';
import type { TogglePlugin } from '@udecode/plate-toggle/dist/react';
